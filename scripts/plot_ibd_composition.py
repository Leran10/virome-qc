#!/usr/bin/env python3
"""Plot the composition of ViroForge IBD gut virome synthetic data (R1 vs R2)."""

import matplotlib.pyplot as plt
import matplotlib.ticker as mtick
import numpy as np

# Read counts from ViroForge IBD Gut Virome dataset
categories = ["Viral", "rRNA", "Host DNA", "PhiX", "Reagent\nBacteria"]
r1_counts = np.array([482123, 6710, 1693, 287, 108])
r2_counts = np.array([482123, 6710, 1693, 287, 108])
...
ax1.set_title("ViroForge IBD Gut Virome Composition\n(VLP-enriched, Heavy Contamination)", fontsize=13, fontweight="bold")
ax1.set_xticks(x)
...
fig.text(0.5, 0.01,
         f"Total reads: R1 = {total_r1:,}  |  R2 = {total_r2:,}  |  Dataset: IBD Gut Virome (90 genomes, 10x coverage, NovaSeq, VLP tangential flow, heavy contamination)",
         ha="center", fontsize=9, color="gray")

plt.tight_layout(rect=[0, 0.04, 1, 1])
outpath = "test_data/ibd_gut_virome/ibd_composition.png"
